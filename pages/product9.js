      ...
      <div className="max-w-[68rem] mx-auto mt-20 px-10 overflow-hidden">
              <div className="flex flex-row gap-6 navsc:flex-row">
                  ...
                  <div className="h-[70%] flex flex-col gap-10 mt-16 flex-1">
                      <div>
                          <p className="font-normal subsc:font-medium navsc:font-normal text-[1.625rem] subsc:text-[2rem] navsc:text-[1.625rem] leading-8 tracking-wide text-[#212121]">Brushed Bomber</p>
                      ...
                      <div className="flex items-center gap-3">
                          ...
                          <span className="font-bold text-2xl leading-7 text-[#212121] tracking-widest">$225.00</span>
                      </div>
                  </div>
              </div>
