          ...
          <div className="max-w-[68rem] mx-auto mt-20 px-10 overflow-hidden">
              <div className="flex flex-row gap-6 navsc:flex-row">
                  ...
                  <div className="h-[70%] flex flex-col gap-10 mt-16 flex-1">
                      <div>
                          <p className="font-normal subsc:font-medium navsc:font-normal text-[1.625rem] subsc:text-[2rem] navsc:text-[1.625rem] leading-8 tracking-wide text-[#212121]">Pink Fleece Sweatpants</p>
                          <p class="font-semibold text-xl subsc:text-3xl navsc:text-xl opacity-20">Pants</p>
                      </div>
                      <div>
                          ...
                          <div className="flex gap-4 mt-5">
                              ...
                              <button class="rounded-full hover:bg-gray-200 duration-150 ease-in-out font-bold leading-4 tracking-wider text-base text-[#666] w-10 h-10 flex justify-center items-center bg-gray-100">L</button>
                              <button class="rounded-full hover:bg-gray-200 duration-150 ease-in-out font-bold leading-4 tracking-wider text-base text-[#666] w-10 h-10 flex justify-center items-center bg-gray-100">XL</button>
                          </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                          ...
                          <span className="font-bold text-2xl leading-7 text-[#212121] tracking-widest">$195.00</span>
                      </div>
                  </div>
              </div>
              <div className="navsc:px-10 mt-24 mb-24 subsc:mb-36 md:mb-56">
                <div className="relative border-b-2 border-[#c4c4c4]">
                    <p className="font-extrabold text-[4rem] subsc:text-[6rem] md:text-[7.5rem] leading-[151px] text-[#f2f3f7] opacity-0.09">Overview</p>
                ...
                <div className="flex mt-10">
                <p class="uppercase font-bold text-base text-[#666] leading-5 tracking-wider flex-1">Product Care</p>
                <div className="flex-[2]">
                    <ul className="ml-3">
                        <li className="list-disc font-medium text-[0.9rem] text-[#240303] leading-[26px] text-justify tracking-wider">Hand wash using cold water.</li>
                        <li className="list-disc font-medium text-[0.9rem] text-[#240303] leading-[26px] text-justify tracking-wider">Do not using bleach.</li>
                        <li className="list-disc font-medium text-[0.9rem] text-[#240303] leading-[26px] text-justify tracking-wider">Hang it to dry.</li>
                        <li className="list-disc font-medium text-[0.9rem] text-[#240303] leading-[26px] text-justify tracking-wider">Iron on low temperature.</li>
                    </ul>
                </div>
                </div>
              </div>
