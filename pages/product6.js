      ...
      <div className="max-w-[68rem] mx-auto mt-20 px-10 overflow-hidden">
              <div className="flex flex-row gap-6 navsc:flex-row">
                  ...
                  <div className="h-[70%] flex flex-col gap-10 mt-16 flex-1">
                      <div>
                          <p className="font-normal subsc:font-medium navsc:font-normal text-[1.625rem] subsc:text-[2rem] navsc:text-[1.625rem] leading-8 tracking-wide text-[#212121]">Flex Sweatpants</p>
                          <p class="font-bold text-xl subsc:text-3xl navsc:text-xl opacity-20">Pants</p>
                      </div>
                      <div>
                      ...
                      <div className="flex items-center gap-3">
                          ...
                          <span className="font-bold text-2xl leading-7 text-[#212121] tracking-widest">$185.00</span>
                      </div>
                  </div>
              </div>
